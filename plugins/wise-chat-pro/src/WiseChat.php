...
class WiseChat {
	...
	*/
	public function registerResources() {
		...
		wp_enqueue_style('wise_chat_libs_css', $pluginBaseURL.'css/3rdparty/libs.min.css');
		wp_enqueue_script('wise_chat_libs_js', $pluginBaseURL.'js/3rdparty/libs.min.js', array('jquery'));
	}
	...
	public function getRenderedChat($channelName = null) {
		...
		$jsOptions = array(
			...
			'fbMessagesWidth' => $this->options->isOptionNotEmpty('chat_width') && !preg_match('/%$/', $this->options->getOption('chat_width', 400))
